...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  ...
  [_SYSTAB] = LAYOUT(
    KC_CAPS, KC_MS_WH_UP , KC_MS_WH_DOWN, KC_END ,  XXXXXXX,      XXXXXXX, CPY_PST, KC_UP  , KC_BSPC , XX_ESC,
    XXX_TAB, KC_MS_BTN1, KC_MS_BTN2, _______ , XXXXXXX,      XXXXXXX, KC_LEFT, KC_DOWN, KC_RIGHT, XX_ENT,
